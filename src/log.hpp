...
#define LOG_CRITICAL(format, ...) \
    platformLog(LOG_LEVEL_CRITICAL, LOG_MODULE, format, ##__VA_ARGS__)
#else
#define LOG_CRITICAL()
#endif
...
#define LOG_ERROR(format, ...) \
    platformLog(LOG_LEVEL_ERROR, LOG_MODULE, format, ##__VA_ARGS__)
#else
#define LOG_ERROR()
#endif
...
#define LOG_WARNING(format, ...) \
    platformLog(LOG_LEVEL_WARNING, LOG_MODULE, format, ##__VA_ARGS__)
#else
...
#define LOG_INFO(format, ...) \
    platformLog(LOG_LEVEL_INFO, LOG_MODULE, format, ##__VA_ARGS__)
#else
#define LOG_INFO()
#endif
...
#define LOG_DEBUG(format, ...) \
    platformLog(LOG_LEVEL_DEBUG, LOG_MODULE, format, ##__VA_ARGS__)
#else
